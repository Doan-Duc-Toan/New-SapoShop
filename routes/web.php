...
Route::middleware('auth')->group(function () {
    ...
    // });
    // Route::get('admin/product/your_products',[ProductController::class,'your_products'])->name('your_products');
    ...
    // Route::get('admin/customer/search', [CustomerController::class, 'search_ajax'])->name('customer.search_ajax');
