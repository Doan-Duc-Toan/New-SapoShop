    ...
    <div id="content">
        <div id="left">
            <div id="l-content">
                ...
                <form action="{{ route('client.buynow_completed',['product'=>$product->id,'color'=>$color,'count'=>$count]) }}" method="POST">
                    @csrf
            ...
            <div id="r-content">
                ...
                <ul id="list-product">
                        <li class="product-item">
                            <div class="p-img">
                                @php
                                    $thumb = $product->thumbs->where('color_id', $color)->first();
                                @endphp
                                @if (!empty($thumb))
                                    <img class="p-img" src="{{ asset($thumb->link) }}" alt="">
                                @endif
                                <span class="count center">{{ $count }}</span>
                            </div>
                            <span class="p-name">{{ $product->name }}</span>
                            <span
                                class="price">{{ number_format($product->price * 0.91 * $count, 0, '.', ',') . ' đ' }}</span>
                        </li>
                </ul>
                <div id="amount">
                    <div class="a-item">
                        ...
                        <span
                            class="money">{{ number_format($product->price * 0.91 * $count, 0, '.', ',') . ' ₫' }}</span>
                    </div>
                    <div class="a-item">
                ...
                <div id="total">
                    ...
                    <span
                        class="total-amount">{{ number_format($product->price * 0.91 * $count, 0, '.', ',') . ' ₫' }}</span>
                </div>
            </div>
        </div>
    </div>
